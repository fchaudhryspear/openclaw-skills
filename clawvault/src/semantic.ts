...
import { SemanticLayer, MemoryEntry } from './types';
import { tokenize, removeStopwords } from './embeddings';
...
export class SemanticLayerBuilder {
  ...
  private assessImportance(content: string, entities: string[], concepts: string[]): number {
    let score = 0.5;
